...
public class MainActivity extends AppCompatActivity implements CvCameraViewListener2,TextToSpeech.OnInitListener{
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        if (diff[index] < 2 && index < 10 && index != 6 && index != 1) {
            ...
            if (index == 0) {
                ...
                if(!(speak=="hackfest18")){
                    tts.speak("welcome to hackfest18", TextToSpeech.QUEUE_FLUSH, null);
                }
                speak="hackfest18";
            } else if (index == 8) {
                Imgproc.putText(result, "Gesture Detected : 'Love'", new Point(5, 50), Core.FONT_HERSHEY_SIMPLEX, 1.1, new Scalar(0, 255, 0), 3);
                if(!(speak=="love")){
                    tts.speak("love coding", TextToSpeech.QUEUE_FLUSH, null);
                }
                speak="love";
            } else if (index == 9) {
