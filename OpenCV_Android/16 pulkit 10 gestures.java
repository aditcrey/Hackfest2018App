...
public class MainActivity extends AppCompatActivity implements CvCameraViewListener2  {
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        //code for gesture 'bird'
        Mat sample7 = null;
        try {
            sample7= Utils.loadResource(this,R.drawable.bird);
        }catch(IOException ex) {
            //Do something with the exception
        }
        ...
        if(diff[index] < 1.5 && index < 10) {
            ...
            // Adding Text
            if(index==0)
                Imgproc.putText(result,"Gesture Detected : 'Yes'",new Point(5,50),Core.FONT_HERSHEY_SIMPLEX,1.1,new Scalar(0,255,0),3);
            else if(index==1)
                ...
                Imgproc.putText(result,"Gesture Detected : 'Bird'",new Point(5,50),Core.FONT_HERSHEY_SIMPLEX,1.1,new Scalar(0,255,0),3);
            else if(index==8)
