  ...
  //      Imgproc.cvtColor(mDilatedMat,mDilatedMat,Imgproc.COLOR_GRAY2RGB);
       ...
       /*
...

        {
            ...
            {
                Imgproc.drawContours ( getHandContour, contours, contourIdx, colorGreen, iLineThickness);
            }
        }
        */
...
/*
       ...
       double maxArea = 0;
        ...
        //Imgproc.rectangle(getHandContour, rect.tl(), rect.br(), new Scalar(0, 255, 0), 2);
